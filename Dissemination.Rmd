...
<!--
* Mozilla Festival 2016 - http://bit.ly/mozfest415
* NCN Software Bootcamp - https://github.com/codedsk/ncnsoftwarebootcamp
-->
...
feature(
    ...
    desc="Research at the University level is filled with stories of code being passed down from grad student to grad student and referenced in papers but rarely being used by others outside of the original research team. In this workshop participants learned about what resources the HUBzero Platform provides to help disseminate that research code, with a web or desktop style graphical user interface, to the world so it can be used by others and built upon in an Open Source ecosystem.<br/><br/>Workshop notes and presentations links: <a href='http://bit.ly/mozfest415'>http://bit.ly/mozfest415</a>"
)
...
feature(
    ...
    desc="Use the Pegasus Workflow Management system from within the HUBzero Platform tool containers, inside your simulation tool or on the command line!<br/><br/>Read the paper: <a href='http://bit.ly/dk-pub-2014-1'>http://bit.ly/dk-pub-2014-1</a>"
)
```
