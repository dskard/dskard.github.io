...
feature(
    ...
    img="images/rappture_logo_150x150.svg",
...
feature(
    title="HUBcheck",
    img="images/hubcheck_logo_150x150.svg",
...
feature(
    title="wrwroxy",
    img="images/wrwroxy_logo_150x150.svg",
...
feature(
    title="invokeapp",
    img="images/invokeapp_logo_150x150.png",
...
feature(
    title="chuse",
    img="images/chuse_logo_150x150.svg",
...
feature(
    title="SolarPV",
    img="images/solarpv_logo_150x150.svg",
...
feature(
    title="ParticleVE",
    img="images/particleve_logo_150x150.svg",
...
feature(
    title="NanoFET",
    img="images/nanofet_logo_150x150.svg",
...
feature(
    title="Workspace",
    img="images/workspace_logo_150x150.svg",
